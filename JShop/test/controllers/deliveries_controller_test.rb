...
class DeliveriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create delivery" do
    assert_difference('Delivery.count') do
      post deliveries_url, params: { delivery: { postman_name: @delivery.postman_name, s_order_id: @delivery.s_order_id } }
    end
  ...
  test "should update delivery" do
    patch delivery_url(@delivery), params: { delivery: { postman_name: @delivery.postman_name, s_order_id: @delivery.s_order_id } }

...
class FollowshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create followship" do
    assert_difference('Followship.count') do
      post followships_url, params: { followship: { shop_id: @followship.shop_id, user_id: @followship.user_id } }
    end
  ...
  test "should update followship" do
    patch followship_url(@followship), params: { followship: { shop_id: @followship.shop_id, user_id: @followship.user_id } }
